...
export declare const WELCOME_FREE_INTERVAL_SEC: number;
/**
 ...
 */
export declare class BinaryVerificationError extends Error {
 ...
 */
export declare function ensureBinary(licenseKey?: string, browserVersion?: string, releaseChannel?: string): Promise<string>;
 ...
 * cached one.
 */
export declare function binaryInfo(browserVersion?: string, releaseChannel?: string): BinaryInfo;
 ...
 */
export declare function checkForProUpdate(licenseKey: string, releaseChannel?: string): Promise<string | null>;
/**
 ...
 */
export declare function welcomeDue(marker: string, pro: boolean): boolean;
/** @internal Exported for testing only. */
export declare function resetPreviewFallbackWarned(): void;
/** @internal Exported for testing only. */
export declare function verifyDownloadChecksum(filePath: string, version?: string): Promise<void>;
/**
 ...
 * @internal Exported for testing only.
 */
export declare function fetchSignedManifest(version?: string): Promise<{
 ...
 * @internal Exported for testing only.
 */
export declare function verifySignature(manifestBytes: Uint8Array, sigB64Bytes: Uint8Array): void;
/** @internal Exported for testing only. */
...
/** @internal Exported for testing only. */
export declare function downloadProBinary(version: string, licenseKey: string): Promise<void>;
/**
 ...
 * @internal Exported for testing only.
 */
export declare function verifyProDownload(filePath: string, version: string): Promise<void>;
/** @internal Exported for testing only. */
