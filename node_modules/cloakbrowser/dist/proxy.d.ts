 ...
 */
export declare function normalizeSocksStringUrl(urlStr: string): string;
/**
 * Reconstruct an HTTP(S) proxy URL with inline credentials from a proxy dict.
 */
export declare function reconstructHttpUrl(proxy: ProxyDict): string;
/**
 * Re-encode credentials in an HTTP(S) proxy URL string for --proxy-server.
 * Same pattern as normalizeSocksStringUrl.
 */
export declare function normalizeHttpStringUrl(urlStr: string): string;
/**
 ...
 */
export declare function resolveProxyConfig(proxy: string | ProxyDict | undefined, browserVersion?: string, licenseKey?: string, releaseChannel?: string): ProxyConfig;
