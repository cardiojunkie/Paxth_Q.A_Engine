 ...
 */
export async function humanScrollIntoView(page, raw, getBox, cursorX, cursorY, cfg) {
 ...
 */
export async function scrollToElement(page, raw, selector, cursorX, cursorY, cfg, timeout) {
    return humanScrollIntoView(page, raw, () => getElementBox(page, selector, timeout), cursorX, cursorY, cfg);
}
export async function getElementBox(page, selector, timeout = 30000) {
